...
@section('content')
    ...
    <div class="login-container">
        <div class="logo">
            <a href="/">
                <svg class="w-16 h-16" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="form">
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="mt-4">
                    <input id="password_confirmation" class="block mt-1 w-full" type="password" name="password_confirmation" required autocomplete="new-password" placeholder="Confirmar Senha" />
                </div>
